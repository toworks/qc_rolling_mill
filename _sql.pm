package _sql;{
  ...
  sub get_fb_melt {
	...
	$query .= "as strength_class, t1.RAZM1 as section, t1.STANDART as standard, t1.SIDE FROM melts t1, ";
	$query .= "(select max(begindt) max_begindt, SIDE from melts where state = 1 group by side) t2 ";
