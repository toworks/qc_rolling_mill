...
--
-- Name: QCRollingMill; Type: DATABASE; Schema: -; Owner: QCRollingMill
--

CREATE DATABASE "QCRollingMill" WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'Ukrainian_Ukraine.1251' LC_CTYPE = 'Ukrainian_Ukraine.1251';


ALTER DATABASE "QCRollingMill" OWNER TO "QCRollingMill";
