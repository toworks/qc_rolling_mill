...
begin
 ...
 {$ENDIF}
      ...
      try
{{$IFDEF DEBUG}
  SaveLog.Log(etDebug, 'FbSqlSettings[1].configured ' + booltostr(FbSqlSettings[1].configured));
  SaveLog.Log(etDebug, 'FbSqlSettings[1].enable ' + inttostr(FbSqlSettings[1].enable));
{$ENDIF}}
...
begin
 ...
 {$ENDIF}
      CriticalSection.Enter;
{{$IFDEF DEBUG}
  SaveLog.Log(etDebug, 'FbSqlSettings[3].configured ' + booltostr(FbSqlSettings[3].configured));
  SaveLog.Log(etDebug, 'FbSqlSettings[3].enable ' + inttostr(FbSqlSettings[3].enable));
{$ENDIF}}
      try
