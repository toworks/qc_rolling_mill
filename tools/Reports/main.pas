...
begin
  ...
  form1.DBGrid1.Columns.Items[4].Title.Caption := 'Коэф. предел тек.';
  form1.DBGrid1.Columns.Items[5].Title.Caption := 'Коэф. временное сопр.';
  form1.DBGrid1.Columns.Items[6].Title.Caption := 'Расчетные плавки';
  form1.DBGrid1.Columns.Items[7].Title.Caption := 'Табл. предел min';
  form1.DBGrid1.Columns.Items[8].Title.Caption := 'Табл. предел max';
  form1.DBGrid1.Columns.Items[9].Title.Caption := 'Тип расчета';
  form1.DBGrid1.Columns.Items[10].Title.Caption := 'Мех. среднее';
  form1.DBGrid1.Columns.Items[11].Title.Caption := 'Мех. ср.квадр.откл.';
  form1.DBGrid1.Columns.Items[12].Title.Caption := 'Мех. min';
  form1.DBGrid1.Columns.Items[13].Title.Caption := 'Мех. max';
  form1.DBGrid1.Columns.Items[14].Title.Caption := 'Мех. разница';
  form1.DBGrid1.Columns.Items[15].Title.Caption := 'Коэф. min';
  form1.DBGrid1.Columns.Items[16].Title.Caption := 'Коэф. max';
  form1.DBGrid1.Columns.Items[17].Title.Caption := 'Темп. среднея';
  form1.DBGrid1.Columns.Items[18].Title.Caption := 'Темп. ср.квадр.откл.';
  form1.DBGrid1.Columns.Items[19].Title.Caption := 'Темп. min';
  form1.DBGrid1.Columns.Items[20].Title.Caption := 'Темп. max';
  form1.DBGrid1.Columns.Items[21].Title.Caption := 'Темп. разница';
  form1.DBGrid1.Columns.Items[22].Title.Caption := 'R';
  form1.DBGrid1.Columns.Items[23].Title.Caption := 'Коррект. min';
  form1.DBGrid1.Columns.Items[24].Title.Caption := 'Коррект. max';
  form1.DBGrid1.Columns.Items[25].Title.Caption := 'Нижний красный';
  form1.DBGrid1.Columns.Items[26].Title.Caption := 'Верхний красный';
  form1.DBGrid1.Columns.Items[27].Title.Caption := 'Нижний зеленый';
  form1.DBGrid1.Columns.Items[28].Title.Caption := 'Верхний зеленый';
