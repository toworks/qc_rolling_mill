...
{$ENDIF}
  ...
  // пределы red
  Form1.chart_left_side.Series[4].AddXY(NOW, LowRedLeft,
    timetostr(DateTimeLeft), clRed); // min
  Form1.chart_left_side.Series[0].AddXY(NOW, HighRedLeft,
    timetostr(DateTimeLeft), clRed); // max

  // пределы green
  Form1.chart_left_side.Series[3].AddXY(NOW, LowGreenLeft,
    timetostr(DateTimeLeft), clGreen); // min
  Form1.chart_left_side.Series[1].AddXY(NOW, HighGreenLeft,
...
{$ENDIF}
  ...
  // пределы red
  Form1.chart_right_side.Series[4].AddXY(NOW, LowRedRight,
    timetostr(DateTimeRight), clRed); // min
  Form1.chart_right_side.Series[0].AddXY(NOW, HighRedRight,
    timetostr(DateTimeRight), clRed); // max

  // пределы green
  Form1.chart_right_side.Series[3].AddXY(NOW, LowGreenRight,
    timetostr(DateTimeRight), clGreen); // min
  Form1.chart_right_side.Series[1].AddXY(NOW, HighGreenRight,
