...
set NSSM=D:\Program\QCOpcToSql\perl\perl\bin\nssm_32.exe
set SERVICE_NAME=ReadOpcToSql
set APP_PATH=D:\Program\QCOpcToSql\perl\perl\bin\perl.exe
set APP_DIR=D:\Program\%SERVICE_NAME%
set APP_PARAMETERS="%SERVICE_NAME%.pl"
set APP_DISPLAYNAME="ArcelorMittal.%SERVICE_NAME%"
set APP_DESCRIPTION="reading data in OPC krug"
set APP_ROTATEBYTES=26214400
set APP_ENVIRONMENTEXTRA="PATH=D:\Program\QCOpcToSql\perl\c\bin;%PATH%"
...
%NSSM% set %SERVICE_NAME% AppEnvironmentExtra %APP_ENVIRONMENTEXTRA%
GOTO menu
