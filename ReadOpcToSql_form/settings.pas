...
var
  ...
  OpcConfigArray: Array [1 .. 8] of String;
...
begin
  ...
  begin
    ...
    if SQuery.FieldByName('name').AsString = '::OPC::tag_light_alert_left' then
      OpcConfigArray[6] := SQuery.FieldByName('value').AsString;
    if SQuery.FieldByName('name').AsString = '::OPC::tag_light_alert_right' then
      OpcConfigArray[7] := SQuery.FieldByName('value').AsString;
    if SQuery.FieldByName('name').AsString = '::OPC::tag_aural_alert' then
      OpcConfigArray[8] := SQuery.FieldByName('value').AsString;
